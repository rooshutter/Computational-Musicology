...
**Explanation**   
The first thing that stands out, is that the songs are not clustered by who they are added. Another interesting aspect is that *Cajun Moon* by J.J. Cole is in its own cluster. If I really search for resemblance in the songs in the same cluster I can find some, but overall the clusters are pretty random. Songs from the same artist are not even in the same cluster, for example *Mercy* and *Stepping Stone* by Duffy are not even close. 
