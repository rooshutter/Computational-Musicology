...
**Differences**  
A difference that really jumps out for me is in the songs that I added. There are a lot of songs in the top left square, which have high acousticness, low energy, low loudness and low valence. I think these songs are those that originated out of my own music taste. Naturally, the song with the lowest valence *Lo Vas A Olvidar* by Billie Eilish and ROSALÍA is one of mine. A song that really stands out is *Me & Mr Jones* by Amy Winehouse added by Julia. It had very high loudness for the amount of acousticness it has.
